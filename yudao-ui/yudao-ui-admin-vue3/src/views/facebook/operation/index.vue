...
onMounted(() => {
  ...
  window.addEventListener('fb:publish-post:result:saved', getList as EventListener)
...
onUnmounted(() => {
  ...
  window.removeEventListener('fb:publish-post:result:saved', getList as EventListener)
})
</script>
