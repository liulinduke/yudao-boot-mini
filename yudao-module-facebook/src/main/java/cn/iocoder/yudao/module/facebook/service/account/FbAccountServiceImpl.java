...
public class FbAccountServiceImpl implements FbAccountService {
    ...
    public void reportProfileUpload(FbAccountProfileReportReqVO reqVO) {
        ...
        updateObj.setProfileUpdateTime(LocalDateTime.now());
        ...
        if (reqVO.getCoverUrl() != null) {
            updateObj.setCoverUrl(reqVO.getCoverUrl());
        }
        if (reqVO.getNickname() != null) {
            updateObj.setProfileNickname(reqVO.getNickname());
        }
        if (reqVO.getSignature() != null) {
            updateObj.setProfileSignature(reqVO.getSignature());
        }
        fbAccountMapper.updateById(updateObj);
    }
